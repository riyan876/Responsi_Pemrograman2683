...
namespace ProjectKostumer
{
    class Program
    {
        ...
        {
            Console.Title = "Responsi UAS Amikom Pemrograman";
            while (true)
            {
                TampilMenu();
                Console.Write("\nPilihan Anda [1-4]: ");
        ...
        static void TampilMenu()
        {
            ...
            Console.WriteLine("1. Tambah Kostumer");
            Console.WriteLine("2. Hapus Kostumer");
            Console.WriteLine("3. Tampilkan Kostumer");
        ...
        static void TambahKostumer()
        {
            ...
            Console.Write("Total Pinjaman Dana  : ");
